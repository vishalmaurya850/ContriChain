    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        <div className="space-y-3">
          ...
          <RadioGroup value={category} onValueChange={setCategory}>
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="environment" className="cursor-pointer">
                Environment
              </Label>
            </div>
            <div className="flex items-center space-x-2">
        ...
        <div className="space-y-3">
          ...
          <Slider value={[minFunding]} min={0} max={10} step={0.5} onValueChange={(value) => setMinFunding(value[0])} />
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              <Checkbox
                id="nearly-funded"
                checked={nearlyFunded}
                onCheckedChange={(checked) => setNearlyFunded(checked === true)}
              />
              <Label htmlFor="nearly-funded" className="cursor-pointer">
                Nearly Funded (&gt;80%)
              </Label>
            </div>
            <div className="flex items-center space-x-2">
